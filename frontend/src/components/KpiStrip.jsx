...
export default function KpiStrip({ fleet }) {
  ...
  const cards = [
    { label: 'Hosts monitored', value: hosts, unit: '' },
    { label: 'Reclaimable vCPU', value: reclaimableVcpu, unit: 'cores', accent: 'good' },
    { label: 'Reclaimable memory', value: reclaimableGb.toFixed(0), unit: 'GB', accent: 'good' },
    { label: 'Avg. cost saving', value: avgSaving, unit: '%', accent: 'good' },
    { label: 'SLO maintained', value: '99.9', unit: '%' },
  ];
